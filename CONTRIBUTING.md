...
Source comments and test names carry historical work-item labels from pre-release planning: milestones (M0–M6, v1.x–v2.x, V2-1…V2-7b, P0), numbered improvements (#1–#43), short codes (C1–C6) and stretch items (S-n). They are not GitHub issue or pull-request numbers in this repository. The honesty gates (a)–(e) are defined in [DESIGN.md](DESIGN.md) §1.
